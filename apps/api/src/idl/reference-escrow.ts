/**
 * The IDL of the `reference_escrow` program as a **value**: `BorshCoder` decodes
 * both accounts and events with it, and outside `target/` there is nowhere
 * else to get it.
 *
 * Generated from `target/idl/reference_escrow.json` by `sync-idl` in `scripts/`
...
export const referenceEscrowIdl = {
  ...
  "instructions": [
    {
      ...
      "accounts": [
        ...
        {
          "name": "buyer_bond_tokens",
          "writable": true
        },
        {
          "name": "seller_bond_tokens",
          "writable": true
        },
        {
          "name": "bond_vault",
